...
exports.connect_apimock = {
    ...
    global_config: function(test) {
        ...
        http.request({
            ...
            response.on('end', function() {
                test.equal(response.statusCode, 404, 'global config url /api/ should not be mocked');
                test.equal(data, 'Cannot GET /api/simple/users/\n');
                test.done();
            });
        }).end();
    },
    ...
    multiple_config1: function(test) {
        test.expect(2);
        http.request({
            path: '/api2/hello',
            method: 'GET',
    ...
    multiple_config2: function(test) {
        test.expect(2);
        http.request({
            path: '/apiX/hello',
            method: 'GET',
